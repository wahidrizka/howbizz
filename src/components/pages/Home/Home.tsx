...
export const Home = () => {
	...
	return (
		<Stack
			...
			style={stackStyles}
		>
			{/* <div className={clsx(styles.gridSystemContentWrapper)}>
				<div className={clsx(styles.gridSystem)} style={gridSystemStyles}>
					<section
						className={clsx(styles.grid, styles.simpleHeroVertical)}
						style={gridStyles}
					>
						<div className={clsx(styles.cross)}>
							<div
						...
						<div className={clsx(styles.block)} style={blockStyles}>
							<Stack
								align="center"
								justify="center"
								padding={{
						...
						<div aria-hidden className={clsx(styles["guides"])}></div>
					</section>
				</div>
			</div> */}

			<Grid.System debug>
				<Grid columns={1} rows={1} height="fit-content">
					<Grid.Cross />
					<Grid.Cell></Grid.Cell>
				</Grid>
			</Grid.System>
